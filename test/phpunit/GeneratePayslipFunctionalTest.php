...
/**
 * \file    test/phpunit/GeneratePayslipFunctionalTest.php
...
/**
 * Class GeneratePayslipFunctionalTest
 *
 ...
 *
 * @package Testgeneratepayslip
 */
class GeneratePayslipFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGeneratePayslip')->click();
		} else {
			// Disable the module
			$this->byHref('modGeneratePayslip')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/generatepayslip/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('generatepayslip/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/generatepayslip/admin/about.php');
		$this->authenticate();
		return $this->assertContains('generatepayslip/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('generatepayslipwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGeneratePayslip_GeneratePayslipTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGeneratePayslip_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
